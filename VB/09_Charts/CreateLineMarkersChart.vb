...
Namespace CreateLineMarkersChart
	Partial Public Class Form1
		...
		Private Sub btnRun_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnRun.Click
			...
			Dim chart As IChart = presentation.Slides(0).Shapes.AppendChart(ChartType.LineMarkers, rect1, False)
			...
			Dim result As String = "CreateLineMarkersChart_result.pptx"
			'Save the document
