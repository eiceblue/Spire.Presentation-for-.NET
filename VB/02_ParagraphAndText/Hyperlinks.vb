...
Public Class Form1
    ...
    Private Sub btnRun_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRun.Click
        ...
        Dim para_title As TextParagraph = shape_title.TextFrame.Paragraphs(0)
        para_title.Alignment = TextAlignmentType.Center
        para_title.TextRanges(0).LatinFont = New TextFont("Myriad Pro Light")
        para_title.TextRanges(0).FontHeight = 36

        'add hyperlink to the shape
        Dim hyperlink As New ClickHyperlink("http://www.e-iceblue.com/Introduce/presentation-for-net-introduce.html")
